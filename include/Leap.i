...
%define %
staticattrib(Class, AttributeType, AttributeName
)
%
...
%define %
leap_list_helper(BaseType)
%
ignore Leap::BaseType
##List::BaseType##

List(const ListBaseImplementation <BaseType> &);
